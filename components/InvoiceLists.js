...
const InvoiceLists = ({
  ...
  return (
    <Pressable
      ...
      onPress={() => onPressNavigation(paymentId)}
    >
      {InvoiceListType === 1 && (
        <>
          <View
          ...
          <View
            style={[styles.dueTextDueDateWrapper, styles.dueWrapperSpaceBlock]}
          >
            <Text style={[styles.dueTextDueDate, styles.SmallsizeText]}>
              {paidDate}
            </Text>
          </View>
      ...
      {InvoiceListType === 2 && (
        <>
          ...
          <View
            style={[styles.dueTextDueDateWrapper, styles.dueWrapperSpaceBlock]}
          >
            <Text style={[styles.dueTextDueDate, styles.dueLayout]}>
              {dueDate}
            </Text>
          </View>
          <View
            style={[styles.totalRateIconParent, styles.dueWrapperSpaceBlock]}
          >
