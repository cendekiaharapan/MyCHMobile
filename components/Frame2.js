...
import CaraouselOption1 from "./CaraouselOption1";
    ...
    <>
      <View style={[styles.newsFrameParent, style]}>
        ...
        >
          <View style={styles.rectangleParent}>
            ...
            />
            <Text style={styles.independenceDatCelebration}>
              Independence Dat Celebration D-2
            </Text>
      ...
      >
        <View style={styles.newsFrameContainerOverlay}>
          ...
          />
          <CaraouselOption1 onClose={closeNewsFrameContainer} />
        </View>
      </Modal>
      ...
      >
        <View style={styles.newsFrameContainer1Overlay}>
          ...
          />
          <CaraouselOption2 onClose={closeNewsFrameContainer1} />
        </View>
      </Modal>
    </>
  );
