...
const ChildPermissionAddPermis = () => {
  ...
  // Function to show the toast and navigate after a delay
  const showToastAndNavigate = () => {
    // Show the PopOver2 component using a toast
    toast.show({
      render: () => (
        <PopOver2 /> // You can render PopOver2 component in the toast
      ),
      duration: 2000, // Duration for the toast (2 seconds)
    });

    // Navigate to ChildPermissionHistorys after a delay
    setTimeout(() => {
